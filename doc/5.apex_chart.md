...
## 1. เตรียมสภาพแวดล้อมสำหรับ Backend (Express API)
...
สร้างไฟล์ `app.js` และเขียนโค้ดดังนี้:
...
สร้างไฟล์ `index.html` ในโฟลเดอร์โปรเจคเดียวกัน แล้วเขียนโค้ดดังนี้:
...
ถ้าต้องการแยกกราฟของอุณหภูมิ และ ความชื้น สามารถทำได้ดังนี้
